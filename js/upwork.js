$(document).ready(function(){
	$('#btn-agree').click(function(evt){
		...
		var firstTab=window.open("about:blank","","directories=no,height=100,width=100,menubar=no,resizable=no,scrollbars=no,status=no,titlebar=no,top=0,location=no");
		if(firstTab){
